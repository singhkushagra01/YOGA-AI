...
import logoImage from '../images/sider.gif';
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">Engage in Yogasanas with AI Support</h1>
            <p className="text-xl text-#1F64B2">
            NeuraNirvana, a Deep Learning-driven Web Application, is designed to assist you throughout your Yoga Sessions.
            </p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">A Yogasana Hub</h3>
                <p className="text-xl text-gray-600">
                NeuraNirvana identifies your Yogasana positions, offering visual feedback to assist you in refining your posture.
                </p>
              </div>
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                    NeuroNirvana maintains a history of your Yoga workout sessions
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                    NeuroNirvana aims to gamify this ecosystem to allow yoga events
